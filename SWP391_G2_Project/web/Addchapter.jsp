        ...
        <aside style="margin-top: 46px" id="sidebar" class="sidebar">
            ...
            <main style="margin-top: 4px" id="main" class="main">
                ...
                <section class="section contact">
                    <div>
                        <div class="card p-4">
                            <form action="addchapter?bookID=${bookID}" method="post">
                                <div class="row gy-4">
                                    <div class="col-md-12">
                                        Chương số 
                                    ...
                                    <div class="col-md-12" >
                                        Tên chương
                                        <!--<input name="namechapter" class="form-control" value="${namechapter}"  type="text">-->
                                        <textarea class="form-control" name="namechapter" rows="1"required>${namechapter}</textarea>
                                    ...
                                    <div class="col-md-12" >
                                        Nội dung
                                        <!--<input name="content" class="form-control" value="${content}"  type="text">-->

                                        <textarea class="form-control" name="content" rows="10" minlength="100" required>${content}</textarea>
