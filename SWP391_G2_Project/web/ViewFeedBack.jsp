                                ...
                                <div class="card-body">
                                    <table class="table">
                                        ...
                                        <c:forEach items="${report}" var="b">
                                            <tr>                              
                                                <td class="title">${b.username==null?"Người dùng muốn khôi phục tài khoản":b.username}</td>
                                                <td class="detail">${b.type}</td>
                                                <td class="detail">${b.detail}</td>
                                                <td><a href="response?userID=${b.userid}&feedback=${b.feedbackid}">Phản hồi</a></td>
                                        </tr>
                                    </c:forEach>
