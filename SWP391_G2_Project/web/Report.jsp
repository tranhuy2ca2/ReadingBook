        ...
        <form action="report" method="post" id="reportForm">
            ...
            <div>
                ...
                <select name="report" id="reportSelect" onchange="toggleDetailInput()">
                    ...
                    <option value="1">Không đọc được nội dung truyện</option>
                    <option value="2">Sai chính tả quá nhiều</option>
                    <option value="3">Thiếu tác giả (hình ảnh, tóm tắt)</option>
                    <option value="4">Truyện có nội dung thô tục, vi phạm thuần phong mỹ tục</option>
