	...
	*/
	...
	HttpServletRequest req = (HttpServletRequest) request;
        ...
        if (ses.getAttribute("user") != null) {
            ...
            } else if (u.getRoldID()== 1) {
                if (url.contains("manageraccount")||
                        url.contains("bancomment")||
                        url.contains("bancommentbook")||
                        url.contains("deletebancomment")||
                        url.contains("addaccount")||
                        url.contains("viewfeedback")||
                        url.contains("response")||
                        url.contains("restore")) {
